...
REGISTRY: list[AlgorithmSpec] = [
    ...
    AlgorithmSpec(
        ...
        params=[
            ParamSpec('n_l', 'Laplace iterations (n_l)', 'int', 20, min=1,
                      help='Laplace relaxation iterations per outer step.'),
            ParamSpec('n_w', 'Warm-up iterations (n_w)', 'int', 50, min=0,
            ...
            ParamSpec('bilinear_interpolation', 'Bilinear interpolation', 'bool', True,
                      help='Sample phi continuously during gradient descent.'),
            ParamSpec('max_outer_iters', 'Max outer iterations', 'int', 1000, min=1,
    ...
    AlgorithmSpec(
        ...
        params=[
            ...
            ParamSpec('epsilon', 'Epsilon', 'float', 0.5, min=0.0, max=1.0, step=0.05,
